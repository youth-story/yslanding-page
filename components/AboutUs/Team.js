...
export default function Team() {
  return (
    <div className='team-container'>
      <h1>Meet the team</h1>
      <p><strong><span style={{color: 'red'}}>D2D</span></strong> is backed and supported by organizations such as <strong>Incubation centre, IIT Patna</strong>, <strong>GeeksforGeeks</strong> and more</p>
      <br />
      <div style={{display: 'flex', flexWrap: 'wrap', gap: '2rem', justifyContent: 'center', alignItems: 'center'}}>
        ...
        <Profile role='Co-founder and COO' name='Shreyas B Chandra' pic={Shreyas} linkedIn='https://www.linkedin.com/in/shreyas-b-chandra-32a786237/' />
